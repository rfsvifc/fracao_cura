...
################################################################################################################
# Cenário 1 - Sem Cura
ajuste <- readRDS("../Ajustes/ajuste_modelagem1.rds")
df_model_all <- readRDS("../DadosGraficos/df_model_ln_all_modelagem1.rds")
df_km <- readRDS("../DadosGraficos/df_km.rds")
...
p1 <- ggplot() +
  ...
  theme_bw() +
  labs(x = "Tempo (em trimestres)", y = "S(t)") +
...
p2 <- ggplot() +
  ...
  theme_bw() +
  labs(x = "Tempo (em trimestres)", y = "h(t)") +
...
# WAIC
waic_1 <- readRDS("../Criterios/waic_modelagem1.rds")
waic_1

################################################################################################################
# Cenário 2 - Intercepto na Cura
ajuste <- readRDS("../Ajustes/ajuste_modelagem2.rds")
df_model_all <- readRDS("../DadosGraficos/df_model_all_modelagem2.rds")
df_km <- readRDS("../DadosGraficos/df_km.rds")
...
# WAIC
waic_2 <- readRDS("../Criterios/waic_modelagem2.rds")
waic_2

################################################################################################################
# Cenário 3 - premium.frequency na Cura
ajuste <- readRDS("../Ajustes/ajuste_modelagem3.rds")
df_model_all <- readRDS("../DadosGraficos/df_model_all_modelagem3.rds")
df_km <- readRDS("../DadosGraficos/df_km.rds")
...
# WAIC
waic_3 <- readRDS("../Criterios/waic_modelagem3.rds")
waic_3

################################################################################################################
# Cenário 4 - premium.frequency + underwriting.age na Cura
ajuste <- readRDS("../Ajustes/ajuste_modelagem4.rds")
df_model_all <- readRDS("../DadosGraficos/df_model_all_modelagem4.rds")
df_km <- readRDS("../DadosGraficos/df_km.rds")
...
data$grupo <- factor(data$grupo,
                     levels = c("NoRider.NonSmoker", "NoRider.Smoker",
                                "Rider.NonSmoker", "Rider.Smoker"))
...
# Densidade da Fração de Cura
ggplot(df_medias, aes(x = p_medio, fill = grupo)) +
  geom_density(alpha = 0.6, color = "black") +
  geom_vline(data = resumo_IC, 
             aes(xintercept = p_medio, color = grupo),
             linetype = "dashed", size = 1) +
  labs(x = "Fração de Cura", y = "Densidade") +
  theme_bw() +
  theme(legend.title = element_blank(),
        legend.text = element_text(size = 20),
        axis.text = element_text(size = 20),
...
# WAIC
waic_4 <- readRDS("../Criterios/waic_modelagem4.rds")
waic_4